...
public class SwitchLeftPipeline extends Command {
     ...
     */
    public SwitchLeftPipeline(CameraSubsystem cameraSubsystem, IntSupplier pipelineIndex) {
    ...
    public void initialize() {
        CameraSubsystem.switchIndex(m_pipelineIndex.getAsInt(), 0);
    }
